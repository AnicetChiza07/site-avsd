    ...
    return (
        <section className="relative py-24 sm:py-42 overflow-hidden">
            ...
            <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                {/* Colonne de gauche : Texte statique (Apparaît en 1er) */}
                <FadeIn>
                    <div className="flex flex-col items-start text-left gap-6">
                        ...
                        <h3 className="w-full text-3xl sm:text-4xl md:text-5xl font-bold leading-tight bg-clip-text text-transparent bg-gradient-to-r from-brand-blue to-brand-light">
                            Découvrez nos dernières actualités
                        </h3>
                        <p className="w-full sm:w-[90%] text-white/60 text-base sm:text-lg leading-relaxed">
                            Restez informé des actions, projets et réussites de l'AVSD sur le terrain. Chaque histoire est un pas vers le changement.
                        </p>
                ...
                {/* Colonne de droite : Carte dynamique (Apparaît en 2ème) */}
                <FadeIn delay={200}>
                    <div className="relative hidden lg:block">
                        {loading ? (
                            // SKELETON : L'animation d'apparition s'est déjà jouée sur le conteneur parent, 
                            // donc le skeleton apparaît proprement sans effet bizarre.
