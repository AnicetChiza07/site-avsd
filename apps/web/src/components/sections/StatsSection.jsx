...
const StatsSection = () => {
    ...
    // Observer pour détecter quand la section est visible (déclenche le comptage)
    useEffect(() => {
        const observer = new IntersectionObserver(
            ([entry]) => {
                if (entry.isIntersecting) {
                    setIsVisible(true);
                    observer.disconnect(); // Ne se déclenche qu'une seule fois
                }
            },
            { threshold: 0.3 }
        );
    ...
    // Animation de comptage des chiffres
    useEffect(() => {
        if (!isVisible) return;
        ...
        >
            <div className="container">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    {/* ✅ CORRECTION : lg:col-span-5 est maintenant DIRECTEMENT sur le FadeIn */}
