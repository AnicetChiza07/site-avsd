...
const FadeIn = ({ children, delay = 0, className = "" }) => {
    ...
    useEffect(() => {
        ...
        }, { threshold: 0.1 }); // Se déclenche dès que 10% du footer est visible
...
const Footer = () => {
    ...
    const navLinks = [
        ...
        { name: 'Nos rapports', href: '/rapports', active: false },
    ...
    return (
        <>
            ...
            {/* Bouton Scroll to Top (Amélioré avec translation) */}
            <button
                onClick={scrollToTop}
                className={`fixed right-6 bottom-6 z-50 w-12 h-12 bg-brand-blue text-white rounded-full flex items-center justify-center shadow-lg shadow-brand-blue/30 hover:bg-brand-blue/90 hover:scale-110 transition-all duration-500 ease-out ${
